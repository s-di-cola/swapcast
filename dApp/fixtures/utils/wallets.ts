...
export const CONTRACT_ADDRESSES = {
	SWAPCAST_NFT: process.env.PUBLIC_SWAPCASTNFT_ADDRESS || '0x292E27B2b439Bb485265aBA27c131247B13593c1',
	TREASURY: process.env.PUBLIC_TREASURY_ADDRESS || '0x43F48c3DC6df4674219923F2d4f8880d5E3CCC4c',
	PREDICTION_MANAGER: process.env.PUBLIC_PREDICTIONMANAGER_ADDRESS || '0x512F94E0a875516da53e2e59aC1995d6B2fbF781',
	ORACLE_RESOLVER: process.env.PUBLIC_ORACLERESOLVER_ADDRESS || '0x541352B9860de4C4bf8d8cC4e79Af90aB6f35A4c',
	REWARD_DISTRIBUTOR: process.env.PUBLIC_REWARDDISTRIBUTOR_ADDRESS || '0x8EfB94E8988dAe48C2E96aBE07bda7585722C7e2',
	SWAPCAST_HOOK: process.env.PUBLIC_SWAPCASTHOOK_ADDRESS || '0xDc1dEb85c5e32b5e3AE56289F86B77456eaa0040',
	POOL_MANAGER: process.env.PUBLIC_UNIV4_POOLMANAGER_ADDRESS || '0x000000000004444c5dc75cB358380D2e3dE08A90',
	UNIV4_STATEVIEW_ADDRESS: process.env.PUBLIC_UNIV4_STATEVIEW_ADDRESS || '0x7ffe42c4a5deea5b0fec41c94c136cf115597227'
} as const;
