...
/**
 * Generate realistic swap amounts for whales based on stake amount and available balance
 */
...
/**
 * Wrapper function that generates realistic swap amounts for fixtures
 */
