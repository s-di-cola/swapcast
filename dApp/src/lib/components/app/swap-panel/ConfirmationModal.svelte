...
<Modal
  bind:open
  class="max-w-md w-full p-0 overflow-hidden"
>
  <div class="p-6">
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-xl bg-gray-50 p-4">
          <div class="flex items-center justify-between">
            ...
            <div class="text-right">
              ...
              <div class="text-sm text-gray-500">1 {payToken?.symbol} = {displayExchangeRate} {receiveToken?.symbol}</div>
            </div>
            <div class="text-right">
        ...
        <div class="rounded-xl bg-gray-50 p-4">
          <div class="space-y-3">
            ...
            <div class="flex items-center justify-between">
              ...
              <span class="font-medium">{formatNumber(predictionStakeAmount)} {payToken?.symbol}</span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-sm text-gray-600">Potential Reward</span>
              <span class="font-medium">{formatNumber(calculations().potentialReward)} {payToken?.symbol}</span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-sm text-gray-600">Net Payout</span>
              <span class="font-medium">{formatNumber(calculations().netPayout)} {payToken?.symbol}</span>
            </div>
            <div class="flex items-center justify-between">
      ...
      <div class="space-y-2 text-sm">
        ...
        <div class="flex items-center justify-between">
          ...
          <span class="font-medium">1 {payToken?.symbol} = {displayExchangeRate} {receiveToken?.symbol}</span>
        </div>
      </div>
      ...
      <p class="text-center text-xs text-gray-500">
        By confirming, you agree to our Terms of Service and acknowledge that you may lose your prediction stake.
      </p>
    </div>
  </div>
</Modal>
