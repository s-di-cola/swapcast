  ...
  <div class="rounded-2xl border border-gray-200 bg-white shadow-sm {disabled ? 'opacity-60' : ''}">
    ...
    <div class="p-6 space-y-6">
      ...
      <div class="space-y-4">
        ...
        <div class="flex justify-center -my-2 relative z-10">
          <button
            ...
            class="flex items-center justify-center w-12 h-12 rounded-full bg-white border-4 border-gray-100 text-gray-600 shadow-lg transition-all hover:bg-gray-50 hover:border-gray-200 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={disabled}
            title="Swap tokens"
          >
            <ArrowUpDown size={20} />
      ...
      <PredictionSection
        ...
        predictedTargetPrice={predictedTargetPrice}
