<script lang="ts">
	...
	const STYLES = {
		header: 'bg-opacity-90 fixed top-0 left-0 z-50 w-full border-b border-gray-100 bg-white backdrop-blur-sm',
		container: 'mx-auto max-w-7xl px-4 sm:px-6 lg:px-8',
		content: 'flex h-16 items-center justify-between',
		brand: 'bg-gradient-to-r from-indigo-600 to-sky-500 bg-clip-text text-xl font-bold text-transparent transition-colors hover:from-indigo-500 hover:to-sky-400',
