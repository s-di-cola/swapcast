...
<section class="mb-10">
	<div class="mb-4 flex items-center justify-between">
		...
		<button
			type="button"
			onclick={onRefresh}
			class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm ring-1 ring-gray-300 ring-inset hover:bg-gray-50"
			disabled={loading}
		>
			<svg
				class="mr-2 -ml-0.5 h-4 w-4 text-gray-700"
				fill="none"
				viewBox="0 0 24 24"
				stroke="currentColor"
				aria-hidden="true"
