...
<section class="mb-10">
    <div class="mb-4 flex items-center justify-between">
        ...
        <div>
            <button
                type="button"
                on:click={() => window.location.href = '/admin/market'}
                class="inline-flex items-center rounded-md bg-indigo-50 px-3 py-2 text-sm font-medium text-indigo-700 transition-colors hover:bg-indigo-100"
            >
                <svg
