...
import { anvil, ink_sepolia, eth_sepolia } from '$lib/configs/networks';
// @ts-ignore
import { PUBLIC_REOWN_PROJECT_ID } from '$env/static/public';

export const networks = [eth_sepolia, anvil, ink_sepolia];
...
export const appKit = createAppKit({
	...
	networks: [eth_sepolia, anvil, ink_sepolia],
	metadata: {
		name: 'SwapCast',
