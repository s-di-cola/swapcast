                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                            ...
                            <div class="inline-flex rounded-md shadow-sm" role="group">
                                ...
                                >
                                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 12" stroke="currentColor" stroke-width="1.5">
                        ...
                        <div class={layoutView === 'grid' ? 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full' : 'grid grid-cols-1 gap-6 w-full max-w-2xl mx-auto'}>
                            ...
                            {:else if filteredMarkets.length === 0}
                                <div class="col-span-full py-8 text-center">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Try adjusting your search to find what you're
                                        looking for.</p>
                                </div>
                            {:else}
                                            ...
                                            <p class="text-sm text-gray-700">
                                                ...
                                                {#if marketData}
                                                    (Page <span class="font-medium">{currentPage}</span> of <span
                                                        class="font-medium">{marketData.totalPages}</span>)
                                                {/if}
                                            </p>
                                        </div>
                                        <div>
