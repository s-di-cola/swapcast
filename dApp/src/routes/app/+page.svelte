      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="flex-shrink-0 flex items-center">
            <span class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-sky-500 bg-clip-text text-transparent">SwapCast</span>
          </div>
          <!-- Navigation Links -->
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            <a href="/app" class="border-indigo-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
              Dashboard
            </a>
            <a href="/app/markets" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
              Markets
            </a>
            <a href="/app/predictions" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
              My Predictions
            </a>
          </div>
        </div>
        ...
        <div class="flex items-center">
          <div class="bg-indigo-50 text-indigo-700 px-3 py-1 rounded-full text-sm font-medium mr-4">
            Mainnet
          </div>
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-100">
            ...
            {#if isLoadingMarkets}
              <div class="flex justify-center items-center py-12">
                ...
                <p class="ml-3 text-gray-600">Loading markets...</p>
              </div>
            {:else if marketError}
              <div class="p-6 text-center text-red-600">
                <p>{marketError}</p>
                <button class="mt-2 px-4 py-2 text-sm bg-gray-100 hover:bg-gray-200 rounded-md" on:click={fetchMarkets}>Retry</button>
              </div>
