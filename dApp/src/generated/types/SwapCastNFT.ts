...
export const SwapCastNFTAbi = [
  ...
  },
  {
    ...
    inputs: [
      {
        name: '_newPredictionManagerAddress',
        type: 'address',
        internalType: 'address',
      },
    ],
 ...
 */
export function getSwapCastNFT({
  address,
  chain,
  transport,
}: {
...
export type SwapCastNFTInstance = ReturnType<typeof getSwapCastNFT>;

// Types for all read functions - using optional chaining for safety
export type SwapCastNFTReadFunctions = SwapCastNFTInstance extends { read: infer R } ? R : never;

// Types for all write functions - using optional chaining for safety
export type SwapCastNFTWriteFunctions = SwapCastNFTInstance extends { write: infer W } ? W : never;
