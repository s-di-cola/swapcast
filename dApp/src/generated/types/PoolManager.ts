...
export type PoolManagerInstance = ReturnType<typeof getPoolManager>;

// Types for all read functions - using optional chaining for safety
export type PoolManagerReadFunctions = PoolManagerInstance extends { read: infer R } ? R : never;

// Types for all write functions - using optional chaining for safety
export type PoolManagerWriteFunctions = PoolManagerInstance extends { write: infer W } ? W : never;
